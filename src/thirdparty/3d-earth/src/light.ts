...
export const initLight = (scene: Scene) => {
  /**
    ...
    */
  // 平行光1
  var directionalLight = new DirectionalLight(0x80b5ff, 100);
  directionalLight.position.set(-250, 250, 100);
  scene.add(directionalLight);
  var directionalLight = new DirectionalLight(0x80d4ff, 100);
  directionalLight.position.set(-250, 250, 100);
  scene.add(directionalLight);
  var directionalLight = new DirectionalLight(0x80b5ff, 100);
  directionalLight.position.set(-250, 250, 100);
  scene.add(directionalLight);
  var directionalLight = new DirectionalLight(0xc2ffff, 100);
  directionalLight.position.set(-250, 250, 100);
  scene.add(directionalLight);
  // 点光1
  var pointLight = new PointLight(0x80d4ff, 100);
  pointLight.position.set(-250, 250, 100);
  scene.add(pointLight);

  // 半球光1
  var hemisphereLight = new HemisphereLight(0xffffff, 0x367188, 100);
  hemisphereLight.position.set(-250, 250, 200);
